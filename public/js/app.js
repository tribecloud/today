...
/* harmony import */ var _components_Todos__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/Todos */ "./resources/js/components/Todos/index.js");
/* harmony import */ var _components_FormTodo__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/FormTodo */ "./resources/js/components/FormTodo.js");
...
function App() {
  ...
  var handleCheckboxClick = function handleCheckboxClick(e, id) {
    e.preventDefault();
    ...
    axios.patch('/api/todos/' + id, {
      ...
      newTodos = newTodos.map(function (item, index) {
        if (item.id === id) {
          item = resp.data;
        }
  ...
  var handleRemove = function handleRemove(e, id) {
    e.preventDefault();
    axios["delete"]('/api/todos/' + id).then(function (resp) {
      var newTodos = _toConsumableArray(todos);

      newTodos = newTodos.filter(function (item, index) {
        return item.id !== id;
      });
      setTodos(newTodos);
    })["catch"](function (err) {
  ...
  var handleFormsubmit = function handleFormsubmit(e, content) {
    e.preventDefault();
  ...
  var handleNavClick = function handleNavClick(e, type) {
    e.preventDefault();
    setType(type);
  };

  var viewedTodos = function viewedTodos() {
    var newTodos = _toConsumableArray(todos);
...
/***/ "./resources/js/components/FormTodo.js":
/*!*********************************************!*\
  !*** ./resources/js/components/FormTodo.js ***!
  \*********************************************/
...
var FormTodo = function FormTodo(props) {
  ...
  var handleSubmit = function handleSubmit(e, content) {
...
/* harmony default export */ __webpack_exports__["default"] = (FormTodo);

/***/ }),

/***/ "./resources/js/components/Todos/Todo/index.js":
/*!*****************************************************!*\
  !*** ./resources/js/components/Todos/Todo/index.js ***!
  \*****************************************************/
/*! exports provided: default */
...
var Todo = function Todo(props) {
  var className = props.completed ? 'todo checked' : 'todo';
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: className
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
    className: "checkbox",
...
/***/ "./resources/js/components/Todos/index.js":
/*!************************************************!*\
  !*** ./resources/js/components/Todos/index.js ***!
  \************************************************/
/*! exports provided: default */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Todo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Todo */ "./resources/js/components/Todos/Todo/index.js");



var Todos = function Todos(props) {
  var todosElement = props.todos.map(function (item, index) {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Todo__WEBPACK_IMPORTED_MODULE_1__["default"], {
      ...
      clicked: function clicked(e) {
        return props.clicked(e, item.id);
      },
      removed: function removed(e) {
        return props.removed(e, item.id);
      }
    });
  });
  return todosElement;
